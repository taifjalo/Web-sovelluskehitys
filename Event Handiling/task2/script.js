...
restaurants.forEach((rest, index) => {
  ...
  tr.dataset.index = index; // store index for modal
...
// b- Highlight clicked row + show modal
...
// c- Display restaurant details in modal
function showRestaurantDetails(index) {
